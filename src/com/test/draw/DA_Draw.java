...
public class DA_Draw {
    ...
    public DA_Draw(f_xj fobj, double [] lb, double [] ub, int Max_iteration, int SearchAgents_no, int orderOfF) {
        this.fobj = fobj;
        dim = ub.length;
        ...
        X = new double[SearchAgents_no][dim+1];
